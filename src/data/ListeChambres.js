export const ListeChambre = [
  ...
  },
  {
    ...
    description:
      "A seulement deux pas des Buttes Chaumont, venez découvrir Paris dans ce studio tout équipé. Entièrement équipé pour votre confort et élégamment décoré, il vous permettra de vivre comme un Parisien le temps de votre séjour.",
    host: {
      name: "Franck Maher",
  ...
  },
  {
    ...
    description:
      "Venez découvrir Paris en séjournant dans ce nid douillet au coeur du 11éme. La vue sur le parc résidentiel saura vous reposer de vos longues journées de tourisme dans la capitale française. Et pour les plus fétards d'entre vous, la rue Jean Pierre Timbaud vous permettra de découvrir la night-life parisienne à seulement 5 minutes de l'appartement.",
    host: {
      name: "Della Case",
      picture: "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-1.jpg",
    },
  ...
  },
  {
    ...
    description:
      "Ce loft entièrement rénovè, et équipé de meubles de luxe saura vous séduire. Idéalement situÃ© dans le 10éme arrondissement, vous déplacer dans Paris sera un véritable jeu d'enfant.",
    host: {
      name: "Franck Maher",
      picture: "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-2.jpg",
    },
  ...
  },
  {
    ...
    description:
      "Idéalement situé à 2 pas de la place de la République, ce studio particulièrement fonctionnel est parfait pour découvrir Paris. Proche de tous les points d'intérèts grâce aux 5 lignes de métro qui sont à 5 minutes, vous pourrez rentabiliser votre temps passé à la capitale.",
    host: {
      name: "Sarah Devit",
  ...
  },
  {
    ...
    description:
      "Ce charmant appartement offre des prestations de luxe, aux portes de Paris. A deux pas de la ligne 3, vous pourrez accéder à toutes les attractions touristiques dont vous avez toujours rêvées.",
    host: {
      name: "Julie Donatella",
      picture: "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-10.jpg",
    },
  ...
  },
  {
    ...
    description: "Ce studio décoré avec goût sera votre nid douillet aprés une longue journée passée à découvrir Paris.",
    host: {
      name: "Michel Romy",
    ...
    equipments: ["Equipements de base", "Four", "Frigo", "Wi-fi", "Micro-Ondes"],
  ...
  },
  {
    ...
    description: "Au coeur du quartier historique du Marais, cet appartement est idÃ©al pour un couple à la découverte de Paris. Situé sur la rue de Rivoli, il est à  5 minutes du Louvre.",
    host: {
      name: "Nathalie Jean",
      picture: "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-12.jpg",
    },
    rating: "4",
    location: "Ile de France - Paris 13e",
    equipments: ["Wi-fi", "Equipements de base", "Micro-Ondes", "Frigo", "Baignoire"],
